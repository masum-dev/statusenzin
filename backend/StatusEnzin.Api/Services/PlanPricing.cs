...
public static class PlanPricing
{
    ...
    public static int GetMaxMonitors(string plan) => plan switch
    {
        "Business" => 100,
        "Pro" => 25,
        _ => 5
    ...
    public static int GetMaxStatusPages(string plan) => plan switch
    {
        "Business" => 10,
        "Pro" => 3,
        _ => 1
    ...
    // Minimum allowed check interval (seconds) per plan
    public static int GetMinIntervalSeconds(string plan) => plan switch
    {
        "Business" => 30,
        "Pro" => 60,
        _ => 300
    ...
    // Returns true if the given interval is allowed for the plan
    public static bool IsIntervalAllowed(string plan, int intervalSeconds) =>
        intervalSeconds >= GetMinIntervalSeconds(plan);
